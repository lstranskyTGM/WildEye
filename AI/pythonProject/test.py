...
# Finde das zuletzt hinzugefügte Bild im Ordner "img"
img_dir = "img"
jpeg_files = [f for f in os.listdir(img_dir) if f.endswith(('.jpeg', '.jpg'))]
if jpeg_files:
    latest_file = max(jpeg_files, key=lambda f: os.path.getctime(os.path.join(img_dir, f)))
