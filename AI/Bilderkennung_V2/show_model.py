...
class Layer():
    def __init__(self, network, number_of_neurons, number_of_neurons_in_widest_layer):
        self.vertical_distance_between_layers = 500  # Increased vertical distance
    ...
    def draw(self, layerType=0):
        ...
        if layerType == 0:
            pyplot.text(x_text, self.y, 'Input Layer', fontsize=128)
        elif layerType == -1:
            pyplot.text(x_text, self.y, 'Output Layer', fontsize=128)
        else:
            pyplot.text(x_text, self.y, 'Hidden Layer ' + str(layerType), fontsize=128)
